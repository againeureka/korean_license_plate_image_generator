...
class ImageGenerator:
    def __init__(self, save_path):
        ...
        # Plate
        self.plate = cv2.imread("./assets/plate.jpg")
        self.plate2 = cv2.imread("./assets/plate_y.jpg")
        self.plate3 = cv2.imread("./assets/plate_g.jpg")

        # loading Number ====================  white-one-line  ==========================
        file_path = "./assets/num/"
